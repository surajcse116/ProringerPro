                    ...
                    if (Photos!=null) {
                        ...
                        for (File file : Photos) {
                            try {
                                ...
                                Logger.printMessage("fileUploadingKey-->",stringArrayListPhotos.get(count));
                                Logger.printMessage("fileUploadingValue-->",""+upload_temp.getAbsolutePath());

                                builderNew.addFormDataPart(stringArrayListPhotos.get(count), upload_temp.getName() + "", RequestBody.create(MEDIA_TYPE_PNG, upload_temp));
...
//                       Logger.printMessage("response", "respose_ww_body::" + response.body().string());
    ...
    public void fireAPIForPostMethodNormalTxtThreeArray(Context mcontext, final String url, final HashMap<String, String> apiPostData, final HashMap<String, String> postArrayText1,final HashMap<String, String> postArrayText2,final HashMap<String, String> postArrayText3, final CustomJSONResponse customJSONResponse) {
        ...
        if (NetworkUtil.getInstance().isNetworkAvailable(mcontext)) {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected void onPreExecute() {
                    ...
                    if (postArrayText1 != null) {
                        myVeryOwnIterator = postArrayText1.keySet().iterator();
                        while (myVeryOwnIterator.hasNext()) {
                            String key = (String) myVeryOwnIterator.next();
                            String value = (String) postArrayText1.get(key);
                            Logger.printMessage(key, value);
                            builderNew.addFormDataPart(key, value);
                        }
                    }
                    ...
                    if (postArrayText2 != null) {
                        myVeryOwnIterator = postArrayText2.keySet().iterator();
                        while (myVeryOwnIterator.hasNext()) {
                            String key = (String) myVeryOwnIterator.next();
                            String value = (String) postArrayText2.get(key);
                            Logger.printMessage(key, value);
                            builderNew.addFormDataPart(key, value);
                        }
                    }

                    if (postArrayText3 != null) {
                        myVeryOwnIterator = postArrayText3.keySet().iterator();
                        while (myVeryOwnIterator.hasNext()) {
                            String key = (String) myVeryOwnIterator.next();
                            String value = (String) postArrayText3.get(key);
                            Logger.printMessage(key, value);
                            builderNew.addFormDataPart(key, value);
                        }
                    }
