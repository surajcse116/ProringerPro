...
import com.android.llc.proringer.pro.proringerpro.activities.Quick_reply;
...
public class SocialMediaFragment extends Fragment implements MyCustomAlertListener {
                                        ...
                                        Log.d("paypal_link",Appdata.paypal);
                                                ...
                                                new CustomJSONParser().fireAPIForPostMethod(getActivity(), AppConstant.save, Params, null, new CustomJSONParser.CustomJSONResponse() {
                                                    ...
                                                    public void onError(String error) {
                                                        ...
                                                        CustomAlert_error customAlert = new CustomAlert_error(getActivity(),"Load Error",""+error,SocialMediaFragment.this);
