...
public class BottomNav {
    ...
    public static final String DASHBOARD = "dashboard", MY_PROJECTS = "my_project", MESSAGES = "messages", WATCH_LIST = "project_or_watch_list_fragment", CREATE_PROJECT = "create_project";
