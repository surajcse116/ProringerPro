...
public class PortfolioEditImageAdapter extends RecyclerView.Adapter<PortfolioEditImageAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<String> portPolioImageGalleryArrayList;
    int screenHeight;
    int screenWidth;

    public PortfolioEditImageAdapter(Context mContext, ArrayList<String> portPolioImageGalleryArrayList) {
