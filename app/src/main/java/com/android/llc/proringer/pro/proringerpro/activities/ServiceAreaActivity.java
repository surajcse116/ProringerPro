...
public class ServiceAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rcv_service_area.setLayoutManager(new GridLayoutManager(ServiceAreaActivity.this,2));
    ...
    public void createListAndAdapterSet(String s){
        ...
        if (serviceAreaAdapter==null){
            serviceAreaAdapter=new ServiceAreaAdapter(ServiceAreaActivity.this,stringArrayList);
